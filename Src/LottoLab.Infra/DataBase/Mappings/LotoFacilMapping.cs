...
namespace LottoLab.Infra.DataBase.Mappings
{
    public class LotoFacilMapping: IEntityTypeConfiguration<LotoFacil>
    {
        public void Configure(EntityTypeBuilder<LotoFacil> builder)
        {
            ...
            builder.Property(L => L.Casa_1).HasMaxLength(2).HasColumnType("int");
            builder.Property(L => L.Casa_2).HasMaxLength(2).HasColumnType("int");
            builder.Property(L => L.Casa_3).HasMaxLength(2).HasColumnType("int");
            builder.Property(L => L.Casa_4).HasMaxLength(2).HasColumnType("int");
            builder.Property(L => L.Casa_5).HasMaxLength(2).HasColumnType("int");
            builder.Property(L => L.Casa_6).HasMaxLength(2).HasColumnType("int");
            builder.Property(L => L.Casa_7).HasMaxLength(2).HasColumnType("int");
            builder.Property(L => L.Casa_8).HasMaxLength(2).HasColumnType("int");
            builder.Property(L => L.Casa_9).HasMaxLength(2).HasColumnType("int");
